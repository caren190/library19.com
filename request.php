...
<div class="container">
	...
	if(isset($_SESSION['login_user']))
	{
		$sql= "SELECT student.username,books.isbn,name,author,edition,publisher,status FROM student inner join issue_book ON student.username=issue_book.username inner join books ON issue_book.isbn=books.isbn WHERE issue_book.approve =''";
